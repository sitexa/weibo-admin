    ...
    LoginByUsername({ commit }, userInfo) {
      ...
      return new Promise((resolve, reject) => {
        authApi.loginByUsername(username, userInfo.password).then(response => {
          ...
          console.log('DEBUG==>LoginByUsername-date:' + JSON.stringify(data))
    ...
    GetUserInfo({ commit, state }) {
      return new Promise((resolve, reject) => {
        authApi.getUserInfo(state.token).then(res => {
          ...
          console.log('DEBUG==>GetUserInfo-res.data.roles:' + JSON.stringify(res.data.roles))
          console.log('DEBUG==>GetUserInfo-res.data.perms:' + JSON.stringify(res.data.perms))
          resolve(res)
        }).catch(error => {
          reject(error)
        })
